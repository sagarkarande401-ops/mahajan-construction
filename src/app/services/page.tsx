...
export const metadata: Metadata = {
  title: "Services",
  description: "Architecture, construction, interior design, planning, turnkey projects, and renovation services from Mahajan Construction.",
};
    ...
    <>
      <section className="container-px mx-auto pb-16 pt-40 md:pb-24">
        ...
        <p className="mt-6 max-w-xl text-lg text-concrete">
          Each service below can stand alone or combine into a full turnkey delivery. Click through for process, FAQs, and to enquire directly.
        </p>
      </section>
      ...
      <section className="pb-24 md:pb-32">
        <div className="container-px mx-auto">
          {services.length === 0 && (
            <p className="text-concrete">No services published yet — add some from the admin panel.</p>
          )}
              ...
              <RevealOnScroll key={service.slug} delay={i * 0.04}>
                ...
                >
                  ...
                  <div>
                    ...
                    <h2 className="mt-4 font-display text-2xl text-ink transition-colors group-hover:text-gold dark:text-canvas">{service.name}</h2>
                    <p className="mt-3 max-w-md text-concrete">{service.shortDescription}</p>
                  </div>
