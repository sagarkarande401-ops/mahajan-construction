...
export const metadata: Metadata = {
  title: "Gallery",
  description:
    "A visual archive of Mahajan Construction's residential, commercial, and interior projects across Maharashtra.",
};
  ...
  return (
    <section className="container-px mx-auto pb-24 pt-8 md:pb-32 md:pt-12">
      ...
      <p className="mt-6 max-w-xl text-lg text-concrete">
        Every image here is uploaded directly by the studio — nothing stock,
        nothing staged. Photos are added regularly as projects progress.
      </p>
