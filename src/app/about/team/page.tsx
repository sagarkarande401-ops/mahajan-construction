...
export const metadata: Metadata = {
  title: "Team",
  description:
    "Meet the site supervisors, designers, and coordinators behind Mahajan Construction's projects.",
};
...
const team = [
  ...
  },
  {
    ...
    img: "https://images.unsplash.com/photo-1568992687947-868a62a9f521?q=80&w=800&auto=format&fit=crop",
  },
];
      ...
      <div className="mt-12 grid grid-cols-1 gap-10 md:grid-cols-3">
        {team.map((member, i) => (
          <RevealOnScroll key={member.name} delay={i * 0.1}>
            ...
            <h3 className="mt-4 font-display text-xl text-ink dark:text-canvas">
              {member.name}
            </h3>
