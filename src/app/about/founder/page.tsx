...
export default function FounderPage() {
  return (
    <section className="container-px mx-auto grid grid-cols-1 gap-16 pb-24 pt-40 md:pb-32 lg:grid-cols-2">
      ...
      <div>
        ...
        <RevealOnScroll delay={0.1} className="mt-6 max-w-xl space-y-5 text-lg leading-relaxed text-concrete">
          ...
          <p>
            ...
            contractor, and an interior designer — so Mahajan Construction was built to remove that gap entirely.
          </p>
          <p>Direct line: <a href={`tel:${siteConfig.phone}`} className="text-ink underline dark:text-canvas">{siteConfig.phoneDisplay}</a> · <a href={`mailto:${siteConfig.email}`} className="text-ink underline dark:text-canvas">{siteConfig.email}</a></p>
        </RevealOnScroll>
      </div>
    </section>
  );
